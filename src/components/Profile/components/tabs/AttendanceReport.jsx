        ...
        {data.reports.map((report, index) => (
          <Box key={index} className="flex flex-col items-start space-y-4">
            ...
            <Box className="p-6 bg-slate-900 text-white rounded-xl border border-gray-700">
              <Typography variant="h6" className="mb-4">Attendance Report</Typography>
              <Box className="mb-4"></Box> {/* Adding space between "Attendance Report" and graphs */}
              <Box className="relative" style={{ width: 200, height: 200 }}>
                ...
                />
                <Box className="absolute top-0 left-0" style={{ width: 160, height: 160, transform: 'translate(20px, 20px)' }}>
                  <CircularProgressBar
                    size={160}
                    strokeWidth={10}
