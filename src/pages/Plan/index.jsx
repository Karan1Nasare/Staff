  ...
  return (
    <>
      ...
      >
        ...
        <div className='text-sm font-medium text-center bg-[#0B1739] text-gray-500 border border-bright__grey  p-8 rounded-md flex items-center justify-between'>
          <div>
            <input
              type='text'
              placeholder='Search Name, Enrollment, Standard'
              className='justify-center items-start self-start px-3 py-3  border border-solid bg-secondary__fill__dark border-bright__grey border-opacity-20  text-white text-opacity-20 w-72 rounded-md'
            />
          </div>
